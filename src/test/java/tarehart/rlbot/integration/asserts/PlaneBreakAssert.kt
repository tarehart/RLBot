...
class PlaneBreakAssert(val plane: Plane, val extent: Float, timeLimit: Duration, delayWhenBallFloating: Boolean = false): PacketAssert(timeLimit, delayWhenBallFloating) {
