...
def ChaseBallBias(s):
    ...
    while i < len(prediction):
        ...
        if intercept_state_distance < 90:
            break
        i += 1
    ...
    # too high, can't reach. go to where the ball height is gonna be reachable
    ...
    if s.aerialing:
        s.tL = s.tL - step(z3, s.pV, z3, s.dT * .99)[0]
