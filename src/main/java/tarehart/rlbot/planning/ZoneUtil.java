...
public class ZoneUtil {
    ...
    public static boolean isEnemyOffensiveBreakaway(Team team, CarData myCar, CarData opponentCar, Vector3 ballPosition) {
    ...
    public static boolean isMyOffensiveBreakaway(Team team, CarData myCar, CarData opponentCar, Vector3 ballPosition) {
