...
class ReflexJumpStrike(heightOfCarAtContact: Float): StrikeProfile() {

    override val preDodgeTime = Duration.ofSeconds(ManeuverMath.secondsForMashJumpHeight(heightOfCarAtContact) ?: .8F + .016F)
    ...
    companion object {
        ...
        fun performJumpHit(preDodgeSeconds: Float): Plan {
            ...
            val plan = Plan().unstoppable().withStep(ReflexStrikeStep())
